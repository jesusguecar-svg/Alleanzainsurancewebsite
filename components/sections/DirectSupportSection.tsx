    ...
    <section id="apoyo-directo" className="overflow-hidden bg-mist px-5 py-28 md:py-40">
      <div className="mx-auto max-w-7xl">
        <motion.div {...reveal} className="mb-12 max-w-3xl">
          <p className="text-xs font-bold uppercase tracking-[.22em] text-cyan">Cómo funciona el apoyo</p>
          <h2 className="mt-5 font-display text-5xl tracking-tight md:text-7xl font-bold">Apoyo que se adapta al momento.</h2>
        </motion.div>
        <div className="grid overflow-hidden rounded-[2rem] border border-navy/10 bg-white shadow-[0_30px_80px_-45px_rgba(6,20,49,.3)] md:grid-cols-2">
          <div className="p-8 md:p-12">
            ...
            <h3 className="mt-8 text-2xl font-bold">Beneficios para tus necesidades</h3>
