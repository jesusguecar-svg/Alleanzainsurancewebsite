...
export function ContactSection() {
  ...
  // The section sits on gris institucional rather than a full-bleed cyan: the
  // brandbook reserves cyan for buttons, links and CTAs, and caps accent
  // colours at roughly 10% of any composition.
  return (
    <section id="contacto" className="relative overflow-hidden bg-mist px-5 py-28 text-navy md:py-40">
      ...
      <motion.div {...reveal} className="relative mx-auto grid max-w-6xl gap-12 md:grid-cols-2 md:items-start">
        <div>
          <p className="text-xs font-bold uppercase tracking-[.24em]">Tu familia. Tu historia. Tu protección.</p>
          <h2 className="mt-6 text-balance font-display text-5xl leading-none tracking-tight md:text-7xl font-bold">Hoy es un buen día para cuidar el mañana.</h2>
          ...
          <div className="mt-10 grid gap-7 sm:grid-cols-2">
            <div>
              <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-[.18em]"><MapPin aria-hidden="true" size={15} /> Oficina</h3>
            ...
            <div>
              <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-[.18em]"><Clock aria-hidden="true" size={15} /> Horario</h3>
            ...
            <div className="sm:col-span-2">
              <h3 className="flex items-center gap-2 text-xs font-bold uppercase tracking-[.18em]"><Phone aria-hidden="true" size={15} /> Teléfonos</h3>
        ...
        <div className="rounded-[2rem] bg-white p-7 shadow-[0_30px_80px_-40px_rgba(6,20,49,.45)] md:p-9">
          {status === "success" ? (
            <div role="status" className="flex flex-col items-start gap-4 py-6">
              ...
              <h3 className="font-display text-3xl font-semibold">Gracias por escribirnos.</h3>
            ...
            <form ref={formRef} onSubmit={handleSubmit} noValidate>
              ...
              <div className="grid gap-5">
                <div>
                  <label htmlFor={fieldId("name")} className="text-sm font-bold">Nombre completo</label>
                ...
                <div>
                  <label htmlFor={fieldId("phone")} className="text-sm font-bold">Teléfono</label>
                ...
                <div>
                  <label htmlFor={fieldId("email")} className="text-sm font-bold">Correo electrónico <span className="font-medium text-navy/45">(opcional)</span></label>
                ...
                <div>
                  <label htmlFor={fieldId("message")} className="text-sm font-bold">Mensaje <span className="font-medium text-navy/45">(opcional)</span></label>
