...
export default function LandingPage() {
  ...
  return <main>
    ...
    <section className="relative overflow-hidden px-5 py-32 md:py-48"><div className="absolute right-[-10%] top-20 h-80 w-80 rounded-full bg-cyan/10 blur-3xl"/><div className="mx-auto grid max-w-7xl gap-14 md:grid-cols-2 md:items-center">
      <motion.div {...reveal}><p className="mb-5 text-xs font-extrabold uppercase tracking-[.22em] text-cyan">La vida no avisa</p><h2 className="text-balance font-display text-5xl leading-[1.02] tracking-tight md:text-7xl">Un diagnóstico no debería decidir el futuro de tu familia.</h2></motion.div>
    ...
    <section id="promesa" className="relative overflow-hidden bg-navy px-5 py-32 text-white md:py-44"><Wing className="-left-20 top-10 h-80 w-56 -rotate-12 opacity-30"/><div className="mx-auto max-w-7xl">
      <motion.div {...reveal} className="mx-auto max-w-3xl text-center"><div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-cyan text-navy shadow-[0_0_45px_rgba(4,192,254,.35)]"><ShieldCheck size={31}/></div><p className="text-xs font-extrabold uppercase tracking-[.22em] text-cyan">La promesa Alleanza</p><h2 className="mt-5 font-display text-5xl tracking-tight md:text-7xl">Protección que se siente cerca.</h2><p className="mt-7 text-lg leading-relaxed text-white/60">No vendemos miedo. Construimos tranquilidad con conversaciones honestas, opciones comprensibles y un equipo que conoce tu historia.</p></motion.div>
    ...
    <section id="proteccion" className="px-5 py-32 md:py-44"><div className="mx-auto max-w-7xl"><motion.div {...reveal} className="max-w-3xl"><p className="text-xs font-extrabold uppercase tracking-[.22em] text-cyan">Protección esencial</p><h2 className="mt-5 font-display text-5xl tracking-tight md:text-7xl">Tres formas de cuidar lo irremplazable.</h2></motion.div>
      <div className="perspective mt-16 grid gap-6 md:grid-cols-3">{[
        {icon:HeartPulse,n:"Cardíaca",state:"cardiac" as ProtectionState,t:"Apoyo económico ante eventos cardíacos cubiertos, para respirar y enfocarte en sanar.",tag:"Corazón protegido"},
        {icon:Stethoscope,n:"Cuidados intensivos",state:"intensive" as ProtectionState,t:"Respaldo diario durante una estadía cubierta en cuidados intensivos.",tag:"Apoyo hospitalario"},
        {icon:Sparkles,n:"Cáncer",state:"cancer" as ProtectionState,t:"Protección pensada para acompañarte desde un diagnóstico cubierto y durante el proceso.",tag:"Fuerza para seguir"}
    ...
    <section id="como" className="overflow-hidden bg-[#eaf8fd] px-5 py-32 md:py-44"><div className="mx-auto max-w-7xl"><motion.div {...reveal} className="text-center"><p className="text-xs font-extrabold uppercase tracking-[.22em] text-cyan">Simple desde el inicio</p><h2 className="mt-5 font-display text-5xl md:text-7xl">Tu tranquilidad, en tres pasos.</h2></motion.div><div className="relative mt-20 grid gap-12 md:grid-cols-3"><div className="absolute left-[16%] right-[16%] top-8 hidden h-px bg-cyan/30 md:block"/>{[["1","Conversemos","Cuéntanos qué quieres proteger. Sin presión, a tu ritmo."],["2","Diseñamos contigo","Revisamos opciones que tengan sentido para tu familia y presupuesto."],["3","Sigues viviendo","Quedas acompañado por un equipo listo para responder."]].map((s,i)=><motion.div key={s[0]} initial={{opacity:0,y:50,scale:.95}} whileInView={{opacity:1,y:0,scale:1}} viewport={{once:true}} transition={{duration:.8,delay:i*.16,ease}} className="relative text-center"><div className="relative z-10 mx-auto flex h-16 w-16 items-center justify-center rounded-full border-4 border-[#eaf8fd] bg-navy text-lg font-bold text-cyan shadow-xl">{s[0]}</div><h3 className="mt-7 text-xl font-extrabold">{s[1]}</h3><p className="mx-auto mt-3 max-w-xs text-sm leading-relaxed text-navy/55">{s[2]}</p></motion.div>)}</div></div></section>

    <section className="relative min-h-[90vh] overflow-hidden bg-navy px-5 py-28 text-white md:py-40"><div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(4,192,254,.18),transparent_35%)]"/><motion.div initial={{scale:1.15}} whileInView={{scale:1}} viewport={{once:true}} transition={{duration:1.8,ease}} className="absolute bottom-[-20%] right-[-5%] h-[85%] w-[58%] rounded-[50%_50%_10%_10%] border border-white/10 bg-gradient-to-br from-white/10 to-transparent shadow-[inset_0_0_80px_rgba(4,192,254,.08)] backdrop-blur-md"/><div className="relative mx-auto flex min-h-[65vh] max-w-7xl items-center"><motion.div {...reveal} className="max-w-2xl"><p className="text-xs font-extrabold uppercase tracking-[.22em] text-cyan">Historias que nos mueven</p><blockquote className="mt-8 font-display text-4xl leading-[1.15] md:text-6xl">“Nuestra mayor tranquilidad fue saber que podíamos concentrarnos en estar juntos.”</blockquote><div className="mt-9 flex items-center gap-4"><div className="h-px w-12 bg-cyan"/><p className="text-sm text-white/55">Una familia como la tuya · Houston, Texas</p></div></motion.div></div></section>
